            ...
            <div class="row no-gutters align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="img-container text-center text-lg-right">
                        <img src="assets/images/banner/social.svg" alt="Social media image" class="img-fluid">
                    </div>
...
<br><br>
<p>
<b>Interactive Advertising</b><br><br>
...
<br><br>
<b>White Paper marketing</b><br><br>
...
<br><br>		  
   ...
   <script language="javascript">
    document.title = "Social Media Marketing :: Digital-Q | Implements Business Expectation";
</script>
