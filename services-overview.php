        ...
        <div class="container">
            <div class="row no-gutters align-items-center">
                <div class="col-lg-6 text-center text-lg-left">
                    <h1>Services</h1>
                    <p class="larger-txt">DigitalQ provides IT professional services, software development focused around Linux and open source technologies and their integration with Microsoft's Windows platform hosted on cloud solution.</p>
                ...
                <div class="col-lg-6">
                    <div class="img-container text-center text-lg-right">
                        <img src="assets/images/banner/home4.svg" alt="services banner image" class="img-fluid">
                    </div>
    ...
    <!-- End of .banner -->
	   ...
	   <section class="contact-us section-gap">
        <div class="container">
            ...
            <p class="larger-txt">Our customer focused team offer website development and design, online ecommerce shopping systems, content management systems, web application design, search engine optimisation (SEO) and website hosting.
<br><br> 
We specialise in the development of database driven websites and are proven experts in web enabling your existing systems for online database integration, ecommerce or intranet development.
<br><br> 
We would be happy to advise on content management system (CMS) integration, and can analyse your existing site for usability and accessibility performance.
<br><br> 
Our honest approach to each project has earned us a reputation for attention to detail, responsive customer service and realistic budget guided pricing. This means you get the right solution at the right price.
<br><br> 
If you are unable to match your requirement to any of the above, then simply contact us and have a small chat with our staff, we're confident we can accommodate your needs.</p>
   ...
   <script language="javascript">
    document.title = "Our Services :: Digital-Q | Implements Business Expectation";
</script>