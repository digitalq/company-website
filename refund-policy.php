        ...
        <nav class="breadcrumb-wrapper" aria-label="breadcrumb">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Refund and Cancellation</li>
                </ol>
            </div>
        </nav>
            ...
            <div class="row no-gutters align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="img-container text-center text-lg-right">
                        <img src="assets/images/banner/opensource.svg" alt="Opensource banner image" class="img-fluid">
                    </div>
...
<p class="accent"><b>Note</b>: During the month of April, we are extending our Money-Back Guarantee from 30 days to 60 days. </p>
...
<br>
   ...
   <script language="javascript">
    document.title = "Opensource Solutions :: Digital-Q | Implements Business Expectation";
</script>